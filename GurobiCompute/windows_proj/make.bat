...
@REM g++ -o gurobicompute.exe -I C:\gurobi811\win64\include -L C:\gurobi811\win64\lib computes_Gurobi.cpp computes_Gurobi_tester.cpp transcribe2Gurobi.cpp utilities_Gurobi.cpp ..\ERfromPD.cpp ..\PDParser\utilities.cpp ..\PDParser\PDparser.cpp -l gurobi81

cl /I %gurobiincludedir% /Fo%objdir%\computes_Gurobi.obj /c computes_Gurobi.cpp
cl /I %gurobiincludedir% /Fo%objdir%\computes_Gurobi_tester.obj /c computes_Gurobi_tester.cpp
...
link /out:gurobicompute.exe %objdir%\computes_Gurobi.obj %objdir%\computes_Gurobi_tester.obj %objdir%\transcribe2Gurobi.obj %objdir%\utilities_Gurobi.obj %objdir%\ERfromPD.obj %objdir%\utilities.obj %objdir%\PDparser.obj %gurobilibdir% %otherwindowslibdirs% %lib%
